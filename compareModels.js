...
var localization = {
    en: {
        ...
        label1: "Compares 2 nested models using a F or a Chi-sq test depending on estimation and runs a likelihood ratio test.",
        ...
        modelselector1: "Select the full model:",
        modelselector2: "Select a model with fewer predictors:",
        help: {
            title: "Compare Models",
...
BSkyFormat(as.data.frame(lrtestResults), singleTableOutputHeader = "Likelihood Ratio Test")
        ...
        var objects = {
            ...
            modelselector2: {
                el: new comboBox(config, {
                    no: 'modelselector2',
                    label: localization.en.modelselector2,
                    multiple: false,
                    required: true,
                    extraction: "NoPrefix|UseComma",
                    options: [],
...
module.exports.item = new compareModels().render()